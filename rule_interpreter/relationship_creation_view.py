...
class RelationshipCreationView:
    ...
    def main(self):
        ...
        titleargs = ptext.draw("Relationship Creation", midtop=(sx/2, 10), owidth=1.2, color = "0x884400", gcolor="0x442200", surf=None, cache = False, fontsize=self._fontsize*4, fontname="CherryCreamSoda")
